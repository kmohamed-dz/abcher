...
function AttendancePage() {
    ...
    const [selectedDate, setSelectedDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AttendancePage.useState": ()=>new Date().toISOString().slice(0, 10)
    }["AttendancePage.useState"]);
    ...
    const loadAttendance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AttendancePage.useCallback[loadAttendance]": async ()=>{
            setLoading(true);
            try {
                ...
                (attendanceRes.data ?? []).forEach({
                    "AttendancePage.useCallback[loadAttendance]": (record)=>{
                        map[record.student_id] = record.status;
                    }
                }["AttendancePage.useCallback[loadAttendance]"]);
                loadedStudents.forEach({
                    "AttendancePage.useCallback[loadAttendance]": (student)=>{
                        if (!map[student.id]) {
    ...
    const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AttendancePage.useMemo[summary]": ()=>{
            const counts = {
                present: 0,
                absent: 0,
                late: 0,
            ...
            Object.values(statusMap).forEach({
                "AttendancePage.useMemo[summary]": (status)=>{
                    counts[status] += 1;
                }
            }["AttendancePage.useMemo[summary]"]);
            return counts;
    ...
    const saveAttendance = async ()=>{
        ...
        if (!canSave) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("ليس لديك صلاحية حفظ الحضور.");
            return;
        }
        setSaving(true);
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("تم حفظ الحضور بنجاح.");
...
_s(AttendancePage, "Ca/PQ/ziqj86sgXbYADGDas+hVo=");
_c = AttendancePage;
var _c;
...
//# sourceMappingURL=app_dashboard_attendance_page_tsx_f28a5413._.js.map