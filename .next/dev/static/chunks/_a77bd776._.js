...
function ForgotPasswordPage() {
    ...
    const onSubmit = async (event)=>{
        ...
        if (!email.trim()) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("أدخل بريدك الإلكتروني.");
            return;
        }
        if (!/^\S+@\S+\.\S+$/.test(email.trim())) {
            setError("صيغة البريد الإلكتروني غير صحيحة.");
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("تحقق من صيغة البريد الإلكتروني.");
            return;
        }
        setLoading(true);
        try {
            ...
            setSent(true);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("تم إرسال رابط إعادة التعيين إلى بريدك الإلكتروني.");
        } catch (err) {
...
_s(ForgotPasswordPage, "tS8g4KA0VWeewCuSV+mtBCA/xpE=");
...
//# sourceMappingURL=_a77bd776._.js.map