...
function DashboardLayout({ children }) {
    ...
    const hasCheckedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardLayout.useEffect": ()=>{
            ...
            const guard = {
                "DashboardLayout.useEffect.guard": async ()=>{
                    try {
                        const { user, profile } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$getCurrentProfile$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentProfile"])();
                        if (!user) {
                            router.replace("/login");
                            return;
                        }
                        if (!profile?.school_id) {
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("أكمل إعداد الحساب أولًا للمتابعة إلى لوحة التحكم.", {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(`تعذر التحقق من الحساب. (${message})`, {
                            id: "dashboard-guard-error"
                        });
                        router.replace("/onboarding");
                    }
                }
            }["DashboardLayout.useEffect.guard"];
            void guard();
        }
    }["DashboardLayout.useEffect"], [
        router
...
_s(DashboardLayout, "FwjRKg+8G2Cn5IVcLoFbRLCIL8s=", false, function() {
    return [
...
//# sourceMappingURL=_75c2938e._.js.map